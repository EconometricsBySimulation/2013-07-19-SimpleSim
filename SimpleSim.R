# I often want to simulate outcomes varying parameters across a set of parameters.
# In order to accomplish this in an efficient manner I have coded up a little
# function that takes parameter vectors and produces results.
# First I will show how to set it up with some dummy examples and 
# next I will show how it can be used to select the optimal blackjack strategy.
